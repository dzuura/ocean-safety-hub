...
router.post("/", authenticateToken, requireAdmin, validateGuideData, guideController.createGuide);
router.put("/:guideId", authenticateToken, requireAdmin, validateGuideData, guideController.updateGuide);
router.delete("/:guideId", authenticateToken, requireAdmin, guideController.deleteGuide);
router.get("/admin/statistics", authenticateToken, requireAdmin, guideController.getStatistics);
...
router.put("/session/:sessionId/checklist/:guideId", authenticateToken, validateChecklistUpdate, guideController.updateChecklistProgress);
